...
<tileset name="componentes" tilewidth="629" tileheight="606" tilecount="10" columns="0">
 ...
 <tile id="2">
  ...
  <objectgroup draworder="index">
   <object id="1" x="37" y="86">
    <polygon points="0,0 2,212 33,210 32,182 168,282 129,186 121,124 126,51 167,-76 33,32 33,0"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="3">
  ...
  <objectgroup draworder="index">
   <object id="1" x="23" y="79">
    <polygon points="0,0 48,-34 65,-69 67,49 421,46 386,67 374,95 385,128 420,153 67,147 68,262 43,222 -1,196"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="4">

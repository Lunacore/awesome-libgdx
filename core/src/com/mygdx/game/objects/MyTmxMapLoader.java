...
public class MyTmxMapLoader extends BaseTmxMapLoader<MyTmxMapLoader.Parameters> {
	 ...
	 * @return the TiledMap */
	public TiledMap load (String fileName, MyTmxMapLoader.Parameters parameters) {
		try {
	...
	@Override
	public void loadAsync (AssetManager manager, String fileName, FileHandle tmxFile, MyTmxMapLoader.Parameters parameter) {
		map = null;
	...
	@Override
	public TiledMap loadSync (AssetManager manager, String fileName, FileHandle file, MyTmxMapLoader.Parameters parameter) {
		return map;
	}
	...
	protected void loadObject (TiledMap map, MapObjects objects, Element element, float heightInPixels) {
		if (element.getName().equals("object")) {
			...
			if(element.getAttribute("template", null) != null){
				...
				//if the instance has a width and height set, overrite the template's width and height
				if(original_width != 0)
